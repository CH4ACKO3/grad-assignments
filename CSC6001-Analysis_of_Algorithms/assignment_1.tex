...
where, in each group, $\lfloor \frac{k}{2} \rfloor$ elements are smaller or equal than the pivot. This totals $\lceil \frac{\lceil \frac{n}{k} \rceil}{2} \rceil \lfloor \frac{k}{2} \rfloor \leq \frac{n}{2k} \lfloor \frac{k}{2} \rfloor \approx \frac{n}{4}$\footnotemark,
